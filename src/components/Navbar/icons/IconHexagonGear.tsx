...
export const IconHexagonGear = React.forwardRef<SVGSVGElement, LogoProps>(({ color = "currentColor", ...props }, forwardedRef) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} ref={forwardedRef}>
        <path d="M9.99967 2.5L16.6664 6.24996V13.75L9.99967 17.4999L3.33301 13.7502L3.33301 6.24993L9.99967 2.5Z" stroke={color} strokeWidth="1.5" strokeLinecap="square" strokeLinejoin="round" />
        <path
