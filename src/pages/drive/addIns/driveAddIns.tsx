        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Callback Function e.g. listenTo((newState) ={`>`} {`{ console.log(JSON.stringify(newState)); }`})</td>
                    <td>Void</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>ShipmentLog: Object {`{driver: {id: '' }, activeFrom: '', dateTime: '', shipperName: '', commodity: ''}`}</td>
...
const OpeningThirdPartyApplicationsUsingURISchema: ReactNode = <div className="paragraph">
    ...
    <CodeSample
        language="javascript"
        code={`window.open("https://google.com", "_blank")`}></CodeSample >
    <InformationalBox>
        ...
        <div className="pageContent" >
            <div className="grayBackground">
                <div className="breadCrumb">
                    ...
                    <span>Add-Ins</span>
                    <IconChevronRightSmall></IconChevronRightSmall>
                    <span>Drive Add-Ins</span>
                </div>
                <h1 className="title">Drive Add-Ins</h1>
                <InformationalBox>
