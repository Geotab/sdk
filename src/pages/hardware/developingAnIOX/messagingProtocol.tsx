...
const generalDescription: ReactNode = (
    <div className="paragraph">
        ...
        <p>This document descripts the IOX Expander Protocol version 1.2.</p>
        <p>All messages since IOX Expander Protocol version 1.0 are supported, unless stated otherwise.</p>
