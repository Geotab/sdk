...
const integrationProcess: ReactNode = (
    <div className="paragraph">
        ...
        <h2>CAN ID</h2>
        <p>The CAN ID is an extended frame message (29-bit) and is broken down into 4 bytes, with the most significant byte (MSB) (byte 1) containing 5 bits to make up the 29-bit ID header. A breakdown
            of the CAN ID is shown below:</p>
        ...
        <ol>
            <li>
                After powering up, the GO device will enter an external device detection cycle. The GO device will listen for a <a href="#msg-type-0x81-third-party-device-id">Msg Type 0x81</a> from the
                external device. This message is used to indicate that an external device is present.
                <ul>
                    <li>The external device must send this message once per second.</li>
                </ul>
            </li>
            <li>The GO device will reply with a <a href="#msg-type-0x02-third-party-data-acknowledge">Msg Type 0x02</a> to acknowledge it has received the external device ID. After detecting this response,
                the external device may stop broadcasting Msg Type 0x81.</li>
            <li>The MyAdmin API can now be used to produce CAN messages from the IOX-CAN as described in <a href="#messages-from-mygeotab">Messages from MyGeotab</a></li>
        </ol>
    </div>
);
...
const messagesFromMyGeotab: ReactNode = (
    <div className="paragraph">
        <p>A <a href="#handshake">handshake</a> must be completed before this functionality will work. To send messages from MyGeotab to the external device, download the source code of the <a target="_blank"
            rel="noopener noreferrer" href="https://geotab.github.io/sdk/software/js-samples/#starter-kit">Starter Kit</a> sample, and replace the <a target="_blank" rel="noopener noreferrer"
                href="https://github.com/Geotab/sdk/blob/master/src/software/js-samples/starterKit.html#L76">Sample API</a> with the following script. The alternative is to paste the script in the <a target="_blank"
                    rel="noopener noreferrer" href="https://geotab.github.io/sdk/software/api/runner.html">Runner</a>.</p>
        <CodeSample
            language="javascript"
            code={
                `api.call("Add", {
...
const appendix: ReactNode = (
    <div className="paragraph">
        ...
        <code className="small-code-sample">
            ...
            CAN ID: 0x000FDB81<br />
            DLC: 02<br />
            Data: 0x70, 0x10<br /><br />
            Third-Party Device ID Acknowledge from GO device<br />
            CAN ID: 0x000FDB02<br />
            DLC: 01<br />
            Data: 0x81<br />
            …<br /><br />
            Third-Party Data from External Device<br />
            (Status Data ID: 9999 = 0x270F, Data Value: 230 = 0x000000E6)<br />
            CAN ID: 0x000FDB80<br />
            DLC: 06<br />
            Data: 0x0F, 0x27, 0xE6, 0x00, 0x00, 0x00<br /><br />
...
export default function Can() {
    return (
        <Page section={HeaderSections.Hardware} pageTitle={pageTitle} tableOfContents={pageSections}>
            <div className="paragraph">
                <p>External devices can communicate with the Geotab GO device through the revised Third-Party Data CAN protocol. The hardware interface will be the <a target="_blank" rel="noopener noreferrer"
                    href="https://www.geotab.com/documentation/iox-can/">IOX-CAN</a>. Two-way communication is supported, allowing a MyGeotab API call to produce messages on the connected CAN network using
