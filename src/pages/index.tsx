      ...
      <div className="landing-page" data-testid="landing-page">
        <div className="landing-page__left">
          <div className="landing-page__text-container">
            <p className="title">
              This site provides tools for integrating with various types of
              Geotab products.{" "}
            </p>
            <div className="subtitle">
              <p>
                You will find the information and tools needed to develop
        ...
        <div className="landing-page__right">
          <div className="landing-page__button-container">
            <div className="landing-page__product-buttons-row">
              <Link
                className="landing-page__product-button"
                to="/myGeotab/introduction"
                onClick={() => handleLinkClick(HeaderSections.MyGeotab)}
              >
                <img
                  src={MyGeotabImage}
                  alt="Navigate to MyGeotab introduction"
                />
              </Link>
              <Link
                className="landing-page__product-button"
            ...
            <div className="landing-page__product-buttons-row">
              ...
              >
                <img
                  src={HardwareImage}
                  alt="Navigate to Hardware introduction"
                />
              </Link>
            </div>
          </div>
