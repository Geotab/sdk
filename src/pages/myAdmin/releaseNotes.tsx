...
const updateSeptember052023: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>
                Along with the new <code className="small-code-sample">Auto-Activated</code> and <code className="small-code-sample">Billing Start Date</code> columns in Device Admin, we have added
                two new parameters to the <strong>GetDeviceContractsByPage</strong> and <strong>GetDeviceContracts</strong> methods:
            </li>
            <ul>
                <li>
        ...
        <ul>
            ...
            <ul>
                ...
                <li>
                    <strong>GetOemSupportEligibilityForMakeAsync</strong> — Returns a result that indicates whether a vehicle make and model in a specific region is eligible for OEM connectivity
                    services.
                </li>
            </ul>
        </ul>
        ...
        <ul>
            <li>
                We have added a new <code className="small-code-sample">shippingCost</code> field as a return object to the <strong>GetOnlineOrderStatus</strong> method. This field will return the
                shipping cost at the time the order was placed.
            </li>
        </ul>
    </div>
);
...
const updateJuly292023: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>
                We have deprecated the <strong>MyAdminApiUser</strong> role. This role was initially used to make MyAdmin API calls, but we confirmed that API calls are open to anyone with a MyAdmin
                account. As a result, we have deprecated the role to reduce confusion and simplify access to our API.
            </li>
        </ul>
        <h2>CalculateVinOemEligibilitiesAsync and GetOemSupportEligibilityForMakeAsync</h2>
        <ul>
        ...
        <ul>
            <li>
                To save time when creating new databases, we've added a new <strong>DatabaseExists</strong> method that returns a true or false value to allow you to confirm whether a database name
                already exists:
            </li>
            <ul>
                <li>
...
const updateJuly012023: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>
                Currently, <strong>ProvisionDevice</strong> and <strong>ProvisionDeviceToAccount</strong> methods are available to provision a single third-party custom telematics or OEM device (via
                the serial number).
            </li>
            <li>
                To help you manage large quantities of devices, we've added a new <strong>ProvisionDevicesBulk</strong> method to provision multiple third-party custom telematics devices or OEM in
                bulk with an optional quantity field.
            </li>
        </ul>
        <h2>GetDeviceContractsByPage and GetDeviceContracts</h2>
        <ul>
            <li>
                In a future release, we will be adding two new columns to Device Admin: <code className="small-code-sample">Auto-Activated</code> and{" "}
                <code className="small-code-sample">Billing Start Date</code> to improve visibility of auto-activation events, as well as the actual start of billing for a device.
            </li>
            <li>
                The <code className="small-code-sample">Auto-Activated</code> column will help you identify whether a device has been automatically activated by Geotab, and display the following
                values:
            </li>
            <ul>
                <li>
        ...
        <ul>
            <li>
                The <code className="small-code-sample">Billing Start Date</code> column will help you determine when billing started for a device. This column will display one of the following
                values:
            </li>
            <ul>
                <li>
            ...
            <li>
                Therefore, we will also be making data points of <code className="small-code-sample">Auto-Activated</code> and <code className="small-code-sample">Billing Start Date</code> available
                through the <strong> GetDeviceContractsByPage</strong> and <strong> GetDeviceContracts</strong> APIs in a future release.We will provide more details closer to the release date.
            </li>
        </ul>
...
const updateSeptember192022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>
                <strong>ApiDeviceContract</strong> has been updated with a boolean value for the <code className="small-code-sample">isAutoActivated</code> parameter to indicate whether a device was
                auto-activated by Geotab using True or False.
            </li>
            <li>The True label indicates the device was auto-activated by Geotab.</li>
        </ul>
        <h2>AccountsFromSerialsAsync</h2>
        <ul>
            <li>
                A new API, <strong>GetAccountsFromSerialsAsync</strong>, has been added to allow our Partners with multiple accounts identify the account associated with a specified device, and
                facilitates the use of other MyAdmin APIs that require account information.
            </li>
        </ul>
        <h2>OnlineOrderStatus</h2>
        <ul>
            <li>
                A new parameter, <code className="small-code-sample">poExactMatch</code>, has been added to <strong>GetOnlineOrderStatus</strong> to allow you to search for orders that match a
                specific PO number.
            </li>
            <li>To search for orders that match an exact PO number, use double quotation marks.</li>
        </ul>
        <h2>End of Life — MyAdmin APIs for Third-party Device Data Ingestion</h2>
        <ul>
            <li>
                On September 30, 2022, the MyAdmin APIs for third-party device data ingestion into MyGeotab will be permanently discontinued. After this date, MyGeotab will be unable to receive data
                from any devices that have not migrated to DIG.
            </li>
            <li>
            ...
            <li>
                If you're a new Partner with a standalone telematics device, refer to the {/* TODO: update link */}
                <a href="https://geotab.github.io/sdk/software/guides/custom-telematics-devices/" aria-label="Using Custom Telematics Devices" target="_blank" rel="noopener noreferrer">
...
const updateSeptember122022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            ...
            <li>The API now identifies the Rate Plan of a specific device in real time, as opposed to only the device mode</li>
        </ul>
        <h2>Moving the MyAdmin SDK Site</h2>
        <ul>
            <li>
                On September 17, 2022, the current MyAdmin SDK site will be deprecated, and the MyAdmin SDK will be merged with the MyGeotab SDK site to create a centralized point of information
                related to integrating with Geotab.
            </li>
        </ul>
        <h2>End of Life — MyAdmin APIs for Third-party Device Data Ingestion</h2>
        <ul>
...
const updateJuly112022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>
                On August 29, 2022, the current MyAdmin SDK site will be deprecated, and the MyAdmin SDK will be merged with the MyGeotab SDK site to create a centralized point of information
                related to integrating with Geotab.
            </li>
        </ul>
        <h2>End of Life — MyAdmin APIs for Third-party Device Data Ingestion</h2>
        <ul>
            ...
            <li>
                If you're a new Partner with a standalone telematics device, refer to the {/* TODO: update link */}
                <a href="Using Custom Telematics Devices" aria-label="https://geotab.github.io/sdk/software/guides/custom-telematics-devices/" target="_blank" rel="noopener noreferrer">
                    Using Custom Telematics Devices
                </a>{" "}
                section in the MyGeotab SDK.
            </li>
...
const updateJune062022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>
                We've added two new parameters — <code className="small-code-sample">ordersAddedFrom</code> and <code className="small-code-sample">ordersAddedTo</code> — to the{" "}
                <strong>GetDeviceContracts</strong> method, so you can retrieve a list of OEM Purchase Order(PO) numbers added during the specific date range.
            </li>
            <li>
...
const updateApril112022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>
                A new API, <strong>GetPartnerDeviceContractsAsync</strong>, has been added to allow Marketplace Partners and Integration Partners to retrieve a list of active devices they've
                produced, as well as the database each device is connected to.
            </li>
            <li>With this API, these Partners can set up, service, and support their products, as well as ensure their products are properly functioning.</li>
            <li>
            ...
            <li>
                To use this API, input <code className="small-code-sample">sessionID</code> in addition to the <strong>GetPartnerDeviceContractsAsync</strong> method. Once this is complete, the API
                call retrieves the list of devices including the Serial Number, Database, and Product Code.
            </li>
            <li>This API is for Partners who produce third-party products only.</li>
        </ul>
        <h2>Shutdown Complete — Disabled GET Requests Used for Authentication</h2>
        <ul>
            <li>
                For several months, we have communicated that we will disable <strong>Authenticate</strong> and <strong>RegisterNewUser</strong> GET requests to the MyAdmin API for increased
                security.
            </li>
            <li>As mentioned, effective March 31, 2022, GET requests have been disabled. POST requests will continue to be supported.</li>
            <li>If GET requests are used for authentication purposes, users will receive the following error message: “405 Method Not Allowed.”</li>
        </ul>
    </div>
);
...
const updateMarch252022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>We've made changes to our current character limit for the Reseller Reference field. We have increased the limit from 250 characters to 500 characters.</li>
        </ul>
        <h2>Shutdown Imminent — Disable GET Requests Used for Authentication</h2>
        <ul>
            <li>
                Effective March 31, 2022, GET requests will be disabled. POST requests will continue to be supported. If GET requests are used for authentication purposes, users will receive the
                following error message: “405 Method Not Allowed.”
            </li>
        </ul>
    </div>
);
...
const updateFebruary282022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            ...
            <li>POST requests will continue to be supported. If GET requests are used for authentication purposes, users will receive the following error message: “405 Method Not Allowed.”</li>
        </ul>
    </div>
);
...
const updateJanuary312022: ReactNode = (
    <div className="paragraph">
        ...
        <ul>
            <li>Serial numbers can now be requested for up to 1000 custom telematics devices (with the same product code) at a time.</li>
            <li>Previously, the functionality only supported one custom telematics device at a time.</li>
        </ul>
        <h2>Update to the NuGet Package</h2>
        <ul>
            <li>
                The NuGet package now includes common elements from the MyGeotab SDK. We leverage .NET Core instructions, so in order to use the new package any integrations using the old .NET
                Framework instructions must be updated.
            </li>
        </ul>
        <h2>Disable GET Requests Used for Authentication</h2>
        <ul>
