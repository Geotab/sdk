...
const creatingAddInDataObject: ReactNode = <div className="paragraph">
    ...
    <div className="table-container">
        <table>
            ...
            <tbody>
                <tr>
                    {/* TODO: replace with correct link when developed */}
...
const additionalResources: ReactNode = <div className="paragraph">
    <ul>
        ...
        <div className="pageContent">
            <div className="grayBackground">
                <div className="breadCrumb">
                    ...
                    <span>Add-Ins</span>
                    <IconChevronRightSmall></IconChevronRightSmall>
                    <span>Using Add-Ins for Data Storage</span>
                </div>
            ...
            <Accordion summary="Additional Resources" p={additionalResources}></Accordion>
        </div>
    );
};