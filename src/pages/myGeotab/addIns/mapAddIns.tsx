...
<<<<<<< HEAD
  <div className="paragraph">
    <p>
      Map Add-ins are installed by uploading an{/*TODO: fix link*/}{" "}
      <Link to="/myGeotab/addIns/developingAddIns">
        Add-in Configuration file
      </Link>{" "}
      into MyGeotab. Click on Administration -{">"} System... -{">"} System
      Settings -{">"} Add-Ins -{">"} New Add-In, and upload the Add-in
      Configuration file. The following is an example of a Map Add-in's
      Configuration file:
    </p>
    ...
    <ol>
      ...
      <li>
        ...
        panel when there are multiple Map Add-ins installed. If a "title" is not
        provided, the Add-in defaults to the "name" parameter.
      </li>
      <li>
      ...
      <li>
        ...
        option can be used instead of src and style. Links to CSS and JavaScript
        files can be made within this HTML file. All content within the
...
const usage: ReactNode = (
  <div className="paragraph">
    ...
    <p>
      ...
      loads when the user visits the Map page.
    </p>
    <p>
      Map Add-ins are loaded inside an iframe with its sandbox attribute set to
      "allow-scripts". This allows the Map Add-in to run custom scripts, such as
      the JavaScript file from the "<strong>src</strong>" parameter in the
      Add-in Configuration file.
    </p>
    <p>Important Notes:</p>
    <ul>
      <li>
        All Map Add-ins installed in a database are active at the same time,
        when the user is on the Map or Trips History page. If different Add-ins
        use the same variable name, it will cause an error and will lead to a
        non-working Add-in. You should name your variables according to your
        solution name - e.g. for "ABC Add-in" you should use "abc" as a prefix
    ...
    <figure>
      <img
        className="mapAddins__image"
        src={mapAddinSizeOnDesktopImage}
        alt="Figure #2 - Map Add-in size on desktop."
      />
    ...
    <figure>
      <img
        className="mapAddins__image"
        src={mapAddinSizeOnMobileImage}
        alt="Figure #3 - Map Add-in size on mobile."
      />
      <figcaption>Figure #3 - Map Add-in size on mobile.</figcaption>
    </figure>
    <p>
      If multiple Map Add-ins are installed, each is accessible by selecting the
      appropriate tab at the top of the panel. In Figure #4, there are 3 add-ins
      installed on the page, denoted by the 3 tabs at the top of the panel. The
      add-ins are titled "Live Trip History", "Tooltip", and "Vehicle Info".
    </p>
    <figure>
      <img
        className="mapAddins__image"
        src={multipleMapAddinsOnTheMapPageImage}
        alt="Figure #4 - Multiple Add-ins on the Map page."
      />
      <figcaption>Figure #4 - Multiple Add-ins on the Map page.</figcaption>
    </figure>
    <h3>Structure</h3>
    <p>
      The starting point for the Map Add-in JavaScript code is the function that
      is added as a method to "window.geotab.addin". For example:
    </p>
    <CodeSample
      language="javascript"
  ...
  <div id="services-list" className="paragraph">
    <div className="mapAddins__docs-service">
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Service for getting/setting page state and moving between MyGeotab
          page
        </p>
        <h3>Methods</h3>
        <div className="table-container">
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  attach {"("}eventName: string, eventHandler: {"("}serviceData:
                  any{")"} ={">"}; void{")"}: void
                </td>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>boolean</td>
                <td>
                  Current map add-in state. It's true if current add-in is
                  focused
                </td>
              </tr>
            </tbody>
    ...
    <div className="mapAddins__docs-service">
      ...
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Tuple for calling server methods where first element is method name
          and second is an object with parameters.
        </p>
      </div>
    </div>
    <div className="mapAddins__docs-service">
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Service for catching events that happens when user interact with
        ...
        <div className="table-container">
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  attach (eventName: string, eventHandler: (serviceData: any) =
                  {">"}; void): void
                </td>
                <td>Attaches event handler to service</td>
              </tr>
              <tr>
                <td>
                  detach (eventName: string, eventHandler?: (serviceData: any) =
                  {">"}; void): void
                </td>
                <td>Detaches event handler to service</td>
              </tr>
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="IDeviceEventData_46524687032941836">
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="IExceptionsEvent_5307836172275417">
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="IExceptionEventData_30321984938642355">
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="IDeviceChangeEvent_12603948382694052">
...
<<<<<<< HEAD
      ...
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Event object that is sent to add-in when user interacts with different
          types of entities on the map
        </p>
      </div>
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Event object that is sent to add-in when something is happened with
...
=======
        ...
        <ol>
            ...
            <li>
                ...
                {"<"}body{">"} tags will be added to the Map Add-in UI {"("}
                {"("}
                <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/html">
                    Example
                </a>
                {")"}
                {")"}.
        ...
        <p>
            You can find example Map Add-ins{" "}
            <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples">
                here
            </a>
            .
>>>>>>> INTGR-123
...
<<<<<<< HEAD
    <div className="mapAddins__docs-service">
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Service for manipulating viewport of the map and getting updates about
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>Empty object</td>
                <td>
                  Event is fired when viewport of map is changed. This event
                  fires each time when use drags or zooms map
                </td>
              </tr>
              <tr>
                <td>changed</td>
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="IChangedViewport_25883856190750576">
    ...
    <div className="mapAddins__docs-service">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>hide (): void</td>
                <td>
                  Hids additional information from already shown and custom
                  tooltip
                </td>
              </tr>
              <tr>
                ...
                <td>
                  Sets configuration for changing current application tooltip
                </td>
              </tr>
              <tr>
                <td>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>string[]</td>
                <td>
                  Secondary information that will be written with smaller font
                </td>
              </tr>
              <tr>
                <td>additional</td>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>string</td>
                <td>
                  Either link to external image or serialized base64 image or
                  stringified SVG image
                </td>
              </tr>
              <tr>
                <td>buffer</td>
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="IDeviceTooltipConfig_6978511226108259">
    ...
    <div className="mapAddins__docs-service">
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Service for showing a custom action list instead of the existing one,
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  shown to add new action button
                </td>
              </tr>
              <tr>
                <td>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div>
                    data: (object) - Data from `IAddinActionItem.data` for the
                    current button
                  </div>
                </td>
                <td>
                  Event is fired when user clicks on custom button in action
                  list. Event name is defined by "clickEvent" property in custom
                  button object.
                </td>
              </tr>
            </tbody>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>string</td>
                <td>
                  URL to external page. If this property is used than button
              ...
              <tr>
                ...
                <td>string</td>
                <td>
                  Name of the event that will be fired when user clicks on this
                  button
                </td>
              </tr>
              <tr>
                ...
                <td>number</td>
                <td>
                  Number that defined position of the custom action button in
                  menu
                </td>
              </tr>
              <tr>
                ...
                <td>object</td>
                <td>
                  Custom data that will be send with `clickEvent` when user
...
<<<<<<< HEAD
    ...
    <div className="mapAddins__docs-service">
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>string</td>
                <td>
                  Type of the segment. Supported types `M`, `m`, `L`, `l`, `Z`,
                  `C`, `c`, `S`, `s`
                </td>
              </tr>
              <tr>
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="ICanvasElementStyleAttributes_7918630799407658">
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="TCanvasElementAttributes_5122011616287052">
      ...
      <div className="mapAddins__docs-service__part">
        <h4 id="TCanvasElementEvent_06428007861141372">
      ...
      <div className="mapAddins__docs-service__part">
        ...
        <p>
          Marker can be presented as a encoded SVG or base64 string or URL to
          third party resource or binary array in ArrayBufferb
        </p>
      </div>
      <div className="mapAddins__docs-service__part">
    ...
    <div id="services-list" className="paragraph">
        <div className="mapAddins__docs-service">
            <div className="mapAddins__docs-service__part">
                <h2>
                    Page Service (
                    <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/page">
                        Example
                    </a>
                    )
                </h2>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>filterChange</td>
                                <td>
                                    groups: (<a href="#IGroupFilterId_6738371814545805">IGroupFilterId</a>
                                    []) - Updated array of filter groups
                                </td>
        ...
        <div className="mapAddins__docs-service">
            <div className="mapAddins__docs-service__part">
                <h2>
                    LocalStorage Service (
                    <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/localStorage">
                        Example
                    </a>
                    )
                </h2>
        ...
        <div className="mapAddins__docs-service">
            <div className="mapAddins__docs-service__part">
                <h2>
                    Api Service (
                    <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/request">
                        Example
                    </a>
                    )
                </h2>
                ...
                <div className="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    multiCall (calls: <a href="#TApiCall_9222282930422152">TApiCall</a>[]): Promise
                                    {"<"}any[][]{">"};
                                </td>
                                <td>Sends multiple requests to Geotab server in one batch</td>
                            </tr>
        ...
        <div className="mapAddins__docs-service">
            <div className="mapAddins__docs-service__part">
                <h2>
                    Events Service (
                    <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/events">
                        Example
                    </a>
                    )
                </h2>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>move</td>
                                <td>
                                    data: (<a href="#ICoordinate_5317711472027584">ICoordinate</a>) - Position of the pointer on the map
                                </td>
                                <td>Event is fired when user moves pointer over the map</td>
                            </tr>
                            <tr>
                                <td>over</td>
                                <td>
                                    data: (<a href="#TEventData_31142352899099124">TEventData</a>) - Main information about entity
                                </td>
                            ...
                            <tr>
                                <td>change</td>
                                <td>
                                    data: (<a href="#TEntityEventData_22932902969493218">TEntityEventData</a>) - Main information about entity and its state
                                </td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>entity</td>
                                <td>
                                    <a href="#IDeviceEventData_46524687032941836">IDeviceEventData</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>entity</td>
                                <td>
                                    <a href="#IRouteEventData_7416072736483916">IRouteEventData</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>entity</td>
                                <td>
                                    <a href="#IExceptionsEventData_5042572438828359">IExceptionsEventData</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>exceptions</td>
                                <td>
                                    <a href="#IExceptionEventData_30321984938642355">IExceptionEventData</a>
                                    []
                                </td>
                            </tr>
                        </tbody>
            ...
            <div className="mapAddins__docs-service__part">
                ...
                <pre>
                    <code>
                        <a href="#IZoneEvent_5628074791384126">IZoneEvent</a> | <a href="#IDeviceEvent_2296851980526009">IDeviceEvent</a> | <a href="#IRouteEvent_2514406342647548">IRouteEvent</a> |{" "}
                        <a href="#ITripEvent_45752359167584244">ITripEvent</a> | <a href="#IExceptionsEvent_5307836172275417">IExceptionsEvent</a>
                    </code>
                </pre>
            ...
            <div className="mapAddins__docs-service__part">
                ...
                <pre>
                    <code>
                        <a href="#IDeviceChangeEvent_12603948382694052">IDeviceChangeEvent</a>
                    </code>
                </pre>
        ...
        <div className="mapAddins__docs-service">
            <div className="mapAddins__docs-service__part">
                <h2>
                    Map Service (
                    <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/map">
                        Example
                    </a>
                    )
                </h2>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        viewport: (<a href="#IChangedViewport_25883856190750576">IChangedViewport</a>) - Current map zoom and bounds
                                    </div>
                                </td>
        ...
        <div className="mapAddins__docs-service">
            <div className="mapAddins__docs-service__part">
                <h2>
                    Tooltip Service (
                    <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/tooltip">
                        Example
                    </a>
                    )
                </h2>
                ...
                <div className="table-container">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    showAt (position: <a href="#TPosition_3201977562385554">TPosition</a>, pattern: <a href="#ITooltip_19241812859555196">ITooltip</a>, sequence: number): void
                                </td>
                                <td>Shows custom tooltip at certain position on the map</td>
                            </tr>
                            <tr>
                                <td>
                                    show (pattern: <a href="#ITooltip_19241812859555196">ITooltip</a>, sequence: number): void
                                </td>
                            ...
                            <tr>
                                <td>
                                    setConfig (config: <a href="#ITooltipConfig_005607970137291307">ITooltipConfig</a>
                                    ): Promise{"<"}boolean{">"}
                                </td>
                            ...
                            <tr>
                                <td>
                                    getConfig (): Promise{"<"}
                                    <a href="#ITooltipConfig_005607970137291307">ITooltipConfig</a>
                                    {">"}
                                </td>
                                <td>Sets configuration for current application tooltip</td>
                            </tr>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>device</td>
                                <td>
                                    <a href="#IDeviceTooltipConfig_6978511226108259">IDeviceTooltipConfig</a>
                                </td>
                                <td>Changes information in devices tooltip</td>
                            </tr>
                        </tbody>
        ...
        <div className="mapAddins__docs-service">
            <div className="mapAddins__docs-service__part">
                <h2>
                    ActionList Service (
                    <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/sdk-map-addin-samples/tree/master/action">
                        Example
                    </a>
                    )
                </h2>
                ...
                <div className="table-container">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    show (position: <a href="#TPosition_3201977562385554">TPosition</a>, title: string, items: <a href="#IMenuActionItem_4783193308694993">IMenuActionItem</a>
                                    []): void
                                </td>
                                <td>Shows custom action menu on certain position</td>
                            </tr>
                            <tr>
                                <td>
                                    attachMenu (menuName: <a href="#TMenuType_5476942457483802">TMenuType</a>, handler: <a href="#TMenuHandler_4714842508362269">TMenuHandler</a>): void
                                </td>
                                <td>Subscribes on event when one of the MyGeotab map menus is shown to add new action button</td>
                            </tr>
                            <tr>
                                <td>
                                    detachMenu (menuName: <a href="#TMenuType_5476942457483802">TMenuType</a>, handler?: <a href="#TMenuHandler_4714842508362269">TMenuHandler</a>): void
                                </td>
            ...
            <div className="mapAddins__docs-service__part">
                <h4 id="IMapMenuEventData_24356897535149513">
                    Interface IMapMenuEventData extends <a href="#IMenuEventData_851292153483612">IMenuEventData</a>
                </h4>
                <p>Data that is passed to add-in when map action menu is about to be shown</p>
            </div>
            <div className="mapAddins__docs-service__part">
                <h4 id="IZoneMenuEventData_4672500566394">
                    Interface IZoneMenuEventData extends <a href="#IMenuEventData_851292153483612">IMenuEventData</a>
                </h4>
            ...
            <div className="mapAddins__docs-service__part">
                <h4 id="IRouteMenuEventData_9403032927960586">
                    Interface IRouteMenuEventData extends <a href="#IMenuEventData_851292153483612">IMenuEventData</a>
                </h4>
            ...
            <div className="mapAddins__docs-service__part">
                <h4 id="IMarkerMenuEventData_490591523581543">
                    Interface IMarkerMenuEventData extends <a href="#IMenuEventData_851292153483612">IMenuEventData</a>
                </h4>
            ...
            <div className="mapAddins__docs-service__part">
                <h4 id="IDeviceMenuEventData_08642871445163691">
                    Interface IDeviceMenuEventData extends <a href="#IMenuEventData_851292153483612">IMenuEventData</a>
                </h4>
            ...
            <div className="mapAddins__docs-service__part">
                <h4 id="ITripMenuEventData_3804169527088357">
                    Interface ITripMenuEventData extends <a href="#IMenuEventData_851292153483612">IMenuEventData</a>
                </h4>
            ...
            <div className="mapAddins__docs-service__part">
                <h4 id="TMenuHandler_4714842508362269">Type TMenuHandler</h4>
                <code>
                    (menuName: string, data: <a href="#TMenuEventData_1566779089066337">TMenuEventData</a>) ={">"} <a href="#IMenuActionItem_4783193308694993">IMenuActionItem</a>[] | Promise{"<"}
            ...
            <div className="mapAddins__docs-service__part">
                <h4 id="TMenuEventData_1566779089066337">Type TMenuEventData</h4>
                <code>
                    <a href="#IMapMenuEventData_24356897535149513">IMapMenuEventData</a> | <a href="#IZoneMenuEventData_4672500566394">IZoneMenuEventData</a> |{" "}
                    <a href="#IRouteMenuEventData_9403032927960586">IRouteMenuEventData</a> | <a href="#IMarkerMenuEventData_490591523581543">IMarkerMenuEventData</a> |{" "}
                    <a href="#IDeviceMenuEventData_08642871445163691">IDeviceMenuEventData</a> | <a href="#ITripMenuEventData_3804169527088357">ITripMenuEventData</a>
                </code>
                <p>Data that is passed to add-in based on type of menu that is shown</p>
            </div>
>>>>>>> INTGR-123
                ...
                <div className="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    text (coords: <a href="#TPosition_3201977562385554">TPosition</a>, text: string, zIndex: number): <a href="#ICanvasElement_6459595766487005">ICanvasElement</a>
                                    {"<"}
                ...
                <div className="table-container">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    attach (event: <a href="#TCanvasElementEvent_06428007861141372">TCanvasElementEvent</a>, handler: (data: <a href="#ICoordinate_5317711472027584">ICoordinate</a>)
                                    ={">"}
                            ...
                            <tr>
                                <td>
                                    detach (event: <a href="#TCanvasElementEvent_06428007861141372">TCanvasElementEvent</a>, handler?: (data: <a href="#ICoordinate_5317711472027584">ICoordinate</a>)
                                    ={">"}
                                    void): <a href="#ICanvasElement_6459595766487005">ICanvasElement</a>
                                    {"<"}T{">"}
                                </td>
...
<<<<<<< HEAD
  <div className="paragraph">
    <p>
      ...
      that can help you understand how to work with Map Add-ins. Download them,
      unzip the files, then follow the instructions in the ReadMe document.
    </p>
  </div>
=======
    <div className="paragraph">
        <p>
            ...
            and{" "}
            <a target="_blank" rel="noreferrer" href="https://github.com/Geotab/map-addins-definitions/">
                type definition files
            </a>{" "}
