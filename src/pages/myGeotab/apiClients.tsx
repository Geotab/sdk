...
const dotnet: ReactNode = (
    <div className="paragraph">
        ...
        <p>Please remember to regularly check for Geotab.Checkmate.ObjectModel nuget package updates. Ideally, your integration
            should use the same Geotab.Checkmate.ObjectModel nuget package version as the one that your database is on.</p>
...
const javascript: ReactNode = (
    <div className="paragraph">
        ...
        <p><strong>Using it in code</strong> {`(`}more on <a target="_blank" rel="noopener noreferrer"
            href="https://github.com/Geotab/mg-api-js">github -
            MyGeotab API wrapper for both clientside JavaScript and NodeJS</a>{`)`}</p>
        <CodeSample
            language="javascript"
            code={
...
const nodejs: ReactNode = (
    <div className="paragraph">
        ...
        <p><strong>Using it in code</strong> {`(`}more on <a target="_blank" rel="noopener noreferrer"
            href="https://github.com/Geotab/mg-api-node">github - nodejs client for the MyGeotab API</a>{`)`}</p>
        <CodeSample
            language="javascript"
            code={
...
const python: ReactNode = (
    <div className="paragraph">
        ...
        <p><strong>Using it in code</strong> {`(`}more on <a target="_blank" rel="noopener noreferrer"
            href="https://github.com/Geotab/mygeotab-python">github - Python client for the MyGeotab SDK</a>{`)`}</p>
        <CodeSample
            language="python"
            code={
                `import mygeotab
...
const php: ReactNode = (
    <div className="paragraph">
        ...
        <p><strong>Using it in code</strong> {`(`}more on <a target="_blank" rel="noopener noreferrer"
            href="https://github.com/Geotab/mygeotab-php">github - PHP client for the MyGeotab SDK</a>{`)`}</p>
        <CodeSample
            language="php"
            code={
