...
const examplesList: ReactNode = (
  <div className="paragraph">
    ...
    <h3>Get fuel tax details (IFTA)</h3>
    <p>An example that shows how to:</p>
    <ul>
    ...
    <h3>Text message</h3>
    <p>An example that sends text messages to and from a GO device.</p>
    <a
    ...
    <h3>Reconcile groups - Alpha version</h3>
    <p>
    ...
    <p>Another console example that imports devices from a CSV file.</p>
    <a
    ...
    <h3>Import zones from shape file</h3>
    <p>
    ...
    <h3>Import users</h3>
    <p>Another console example that imports users from a CSV file.</p>
    <a
...
const pageSections: TableOfContentsItem[] = [
  ...
  {
    elementId: "examples-list",
    summary: "Examples list",
    details: examplesList,
  },
];
