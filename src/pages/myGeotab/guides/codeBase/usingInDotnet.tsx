...
const nugetPackage: ReactNode = <div>
    {/*TODO: fix link*/}
    The <a href="https://www.nuget.org/packages/Geotab.Checkmate.ObjectModel/">nuget package</a> is an SDK library for accessing MyGeotab customer databases. It is a convenient "wrapper"
    around Geotab's HTTP/JSON API to allow developers focus on writing code instead of moving data over the wire. It includes tools to assist authenticating against Geotab's servers,
    automatically serializing/deserializing JSON, and providing definitions for Checkmate object classes.
    <br></br>
...
const apiClass: ReactNode = <div>
    ...
    ></CodeSample>
    <p>The last parameter to this Call method is an {/*TODO: fix link*/}[anonymous object](http://msdn.microsoft.com/en-us/library/bb397696.aspx) which contains the parameters for the method (please review the
        <a href="../../api/reference/#Remove1">API reference</a> to see which parameters the method expects, and whether the parameters are required or optional). The parameter order is not significant,
        and it is acceptable to omit optional parameters. Optional parameters will revert to their default values, typically "null" or “false” values.</p>
    ...
    ></CodeSample>
    <InformationalBox>
        <p>Hint: async main method requires {/*TODO: fix link*/}<a href="https://docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-7-1">C# 7.1</a>.</p>
    </InformationalBox>
...
const nextSteps: ReactNode = <div>
    Once you have a basic understanding of how the .NET SDK works, we recommend reviewing the examples that we have created {/*TODO: fix link*/}<a href="https://github.com/Geotab/sdk-dotnet-samples">here</a>.
</div>
    ...
    return (
        <Page section={HeaderSections.MyGeotab} pageTitle={pageTitle} tableOfContents={pageSections}>
            <div className="paragraph">
                ...
                <a href="http://en.wikipedia.org/wiki/JSON">JSON</a>{/*TODO: fix link*/} format. The .NET library provided will automatically handle the JSON serialization and deserialization into MyGeotab objects.
            </div>
