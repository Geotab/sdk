...
const technicalDetails: ReactNode = (
    <div className="paragraph">
        ...
        <p>
            ...
            the fuel used while road speed is 0, is also saved on ignition off. “Total fuel used (since telematics device install)” (
            <HashLink to="/myGeotab/apiReference/objects#KnownId">KnownId</HashLink> {/* TODO: Need to replace this with routing to KnownId page*/}{" "}
            <code className="small-code-sample">DiagnosticDeviceTotalFuelId</code>) and “Total fuel used while idling (since telematics device install)”{" "}
            <code className="small-code-sample">DiagnosticDeviceTotalIdleFuelId</code> are the diagnostics used to track fuel consumption.
        </p>
