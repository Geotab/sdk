            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>string</td>
                        <td>
                            Describes the type of media. Read- only. <code className="small-code-sample">Video</code>, <code className="small-code-sample">Image</code>
                        </td>
                    </tr>
                    <tr>
                        <td>status</td>
                        <td>string</td>
                        <td>
                            Describes the processing status of the file. Read-only. <code className="small-code-sample">NoFile</code>, <code className="small-code-sample">Processing</code>,{" "}
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>object[Id]</td>
                        <td>
                            Search for a single MediaFile by <code className="small-code-sample">Id</code>.
                        </td>
                    </tr>
                    <tr>
                        <td>deviceSearch</td>
                        ...
                        <td>
                            Search for MediaFile records relating to this DeviceSearch Id. Available DeviceSearch options are: <code className="small-code-sample">Id</code> and{" "}
                    ...
                    <tr>
                        ...
                        <td>
                            Search for MediaFile records relating to this DriverSearch Id. Available DeviceSearch options are: <code className="small-code-sample">Id</code>.
                        </td>
                    </tr>
                    <tr>
                        <td>fromDate</td>
...
const security: ReactNode = (
    <div className="paragraph">
        ...
        <h3>Scope</h3>
        <p>
            Scope is evaluated by the scope of the requesting user to the linked entity(s) (<code className="small-code-sample">Device</code> and/or <code className="small-code-sample">Driver</code>
            ) of the media file. A media file with no linked entity will be visible to any user in the database regardless of scope (requiring <code className="small-code-sample">ViewMedia</code>{" "}
            clearance).
        </p>
    </div>
);
...
const api: ReactNode = (
    <div className="paragraph">
        ...
        <p>
            First, adding the <code className="small-code-sample">MediaFile</code> entity using the generic <code className="small-code-sample">Add</code> method. The result of adding is the unique
            identifier (<code className="small-code-sample">Id</code>) of the added <code className="small-code-sample">MediaFile</code>. When the media file has been added but there is no binary
            uploaded the <code className="small-code-sample">MediaFile.Status</code> will be <code className="small-code-sample">NoFile</code>.
        </p>
        <p>
            Second, uploading the <code className="small-code-sample">MediaFile</code> binary using the <code className="small-code-sample">UploadMediaFile</code> API specifying the{" "}
            <code className="small-code-sample">MediaFile</code> it relates to by <code className="small-code-sample">Id</code> in the JSON-RPC request. After a file is uploaded the{" "}
            <code className="small-code-sample">MediaFile.Status</code> will transition to <code className="small-code-sample">Processing</code> then <code className="small-code-sample">Ready</code>
            .
        </p>
        <InformationalBox>
            <p>
                <code className="small-code-sample">Processing</code> state is available but currently unused.
            </p>
        </InformationalBox>
        <h3>Get</h3>
        <p>Like Add, Get requires two steps:</p>
        <p>
            First, search for <code className="small-code-sample">MediaFile</code> using <code className="small-code-sample">MediaFileSearch</code> to provide search arguments.
        </p>
        <p>
            Second, download the binary using the <code className="small-code-sample">DownloadMediaFile</code> method providing the <code className="small-code-sample">Id</code> of the media file.
        </p>
    </div>
);
...
const limits: ReactNode = (
    <div className="paragraph">
        ...
        <p>
            <b>GetFeed:MediaFile, Add:MediaFile, Set:MediaFile, Remove:MediaFile</b> 60 requests per minute, per user
        </p>
        <p>
            <b>DownloadMediaFile</b> 240 file download requests per minute, per user
        </p>
        <p>
    ...
    return (
        <Page section={HeaderSections.MyGeotab} pageTitle={pageTitle} tableOfContents={pageSections}>
            <div className="paragraph">
                ...
                <ul>
                    <li>
                        The <code className="small-code-sample">MediaFile</code> entity which describes the binary media. This is similar to other generic entity types in the API and follows the
