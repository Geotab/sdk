...
const overview: ReactNode = (
    <div className="paragraph">
        <p>
            This guide describes the general flow for ETL users to consume{" "}
            <a href="https://docs.google.com/document/d/1PEY6L5i3UlVV-5S9FaAV0MHnReCl9vgLxs_mLs26yVo/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
                Geotab Data Connector
            </a>
            . OData Connector implemented OData protocol V4, or you may consider it just as a RESTful service.
        </p>
    </div>
);
...
const endpoint: ReactNode = (
    <div className="paragraph">
        <p>
            Before making your first call, it is strongly recommended to skip the <HashLink to="./#general-entry">general entry</HashLink> and make the call directly to{" "}
            <HashLink to="./#odata-connector">OData Connector</HashLink>. If you are not sure what the URL to call is, please contact the support team.
        </p>
        <h2 id="general-entry">General Entry</h2>
        <p>
            Feel free to skip this section if you plan to make calls directly to OData Connector. If you have to make a call to the general entry (https://data-connector.geotab.com), make sure you
            are ready to handle the 302 response and make another call to the returned URL.
        </p>
...
`}
        ...
        <p>
            ...
            <code className="small-code-sample">{"<database>/<username>:<password></password>"}</code>
        </p>
        <p>
            <b>e.g.</b> abccompany/geotab-data-connector@geotab.com:password Sample request:
        </p>
        <CodeSample
            language="text"
            code={`curl --request GET \\
...
`}
        />
        <p>
            You can also specify a date range as the query option, for more information about the query option, see{" "}
            <a href="https://docs.google.com/document/d/1PEY6L5i3UlVV-5S9FaAV0MHnReCl9vgLxs_mLs26yVo/edit#heading=h.xcvdktyx0p8t" target="_blank" rel="noopener noreferrer">
                here
            </a>
            .
        </p>
...
const tableSchema: JSX.Element = (
    <div className="paragraph">
        <p>
            Please refer to{" "}
            <a href="https://docs.google.com/document/d/1-Id2ReZcR8c-qudzY-dw8AzGTlMEzwO_mScg45vplDU/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
                Geotab Data Connector - Data Schema and Dictionary
            </a>{" "}
            for current available data and details about table schema.
        </p>
    </div>
);
