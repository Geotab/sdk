...
const endpoint: ReactNode = (
    <div className="paragraph">
        <p>
            Before making your first call, it is strongly recommended to skip the <a href="#general-entry">general entry</a> and make the call directly to{" "}
            <a href="#odata-connector">OData Connector</a>. If you are not sure what the URL to call is, please contact the support team.
        </p>
        <h2>General Entry</h2>
        <p>
