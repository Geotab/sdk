export default function Introduction() {
    return (
        <div>
            ...
            <h2>Accessing the device’s data</h2>
            <p>
            ...
            <h2>Importing, exporting and synchronizing</h2>
            <p>
            ...
            <h2>Integrating with MyGeotab</h2>
            <p>
            ...
            <h2>Integrating custom telematics tracking devices into MyGeotab</h2>
            <p>
            ...
            <h2>Technical Software Toolkit</h2>
            <p>
