export default function Introduction() {
    return (
        <div>
            ...
            <details>
                <summary>Accessing the device's data</summary>
                <p>
            ...
            <details>
                <summary>Importing, exporting and synchronizing</summary>
                <p>
            ...
            <details>
                <summary>Automating tasks</summary>
                <p>
            ...
            <details>
                <summary>Working with Add-Ins</summary>
                <p>
            ...
            <details>
                <summary>Integrating with MyGeotab</summary>
                <p>
            ...
            <details>
                <summary>Integrating custom telematics tracking devices into MyGeotab</summary>
                <p>
            ...
            <details>
                <summary>Technical Software Toolkit</summary>
                <p>
