...
const deviceData: ReactNode = (
    <div className="paragraph">
        ...
        <InformationalBox>
            <p>
                See the full list of supported data feed types <Link to="/method/GetFeed1">here</Link>
            </p>
            {/*TODO: is this right?*/}
        </InformationalBox>
...
const integratingWithMyG: ReactNode = (
    <div className="paragraph">
        <p>
            You can integrate an embedded version of MyGeotab into your own web application. This is perfect for providing a website to your customers with insight as to where their deliveries are
            and when they will arrive. You have control of which features appear on the embedded MyGeotab to create a seamless integration between your software and ours.
        </p>
        ...
        Each of the MyGeotab pages has a URL (Uniform Resource Locator) associated with the page that allows that page to be embedded in your own application or linked to. This is a great way to
        leverage MyGeotab and make it part of your services. See <Link to="/myGeotab/guides/MyGeotabUrls">mygeotab-urls</Link> for more details.
    </div>
);
...
const customDevices: ReactNode = (
    <div className="paragraph">
        <p>
            Custom telematics devices can have their data added into the MyGeotab database. The Geotab API is used to provision and upload the devices data. Additionally, data from these devices can
            be used in conjunction with data collected by Geotab GO devices. Contact Geotab support to have your custom telematics device added (each device type will receive a unique prefix code)
            and contact your reseller to handle billing.
        </p>
        <p>
            Note: There may be differences in how devices from custom telematics manufacturers record the data; frequency of data collection and accuracy of the device record may vary. The rich
            information contained in the MyGeotab reports may not be fully available. Testing of these tracking device will be required to properly integrate the data into MyGeotab.
        </p>
...
export default function Introduction() {
    return (
        <Page section={HeaderSections.MyGeotab} pageTitle={pageTitle} tableOfContents={pageSections}>
            <div className="paragraph">
                <p>
                    The MyGeotab SDK (Software Development Kit) is a powerful set of tools for automating tasks and working with the data in MyGeotab. Within these documents you will find
                    information on how to develop JavaScript and C# applications, build and integrate Add-Ins and use MyGeotab with third-party systems.
                </p>
                Various working examples are included in this SDK for use as a starting point with your own code e.g.:
                <ul>
                    <li>
                        Display vehicle trips on third-party map (for example{" "}
                        <a href="http://leafletjs.com/" target="_blank" rel="noopener noreferrer">
                            Leaflet
                        </a>{" "}
                        or{" "}
                        <a href="https://developers.arcgis.com/javascript/" target="_blank" rel="noopener noreferrer">
                ...
                <InformationalBox>
                    <p>
                        Keep up to date with Geotab's technical updates by subscribing to our{" "}
                        <a href="https://www.geotab.com/subscription/" target="_blank" rel="noopener noreferrer">
                            technical bulletins
                        </a>
                        .
                    </p>
