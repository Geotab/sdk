...
window.jscolor = {
    ...
    detectDir: function () {
        ...
        for (i = 0; i < elem.length; i += 1) {
            if (elem[i].src && /(^|\/)jscolor\.js([?#].*)?$/i.test(elem[i].src)) {
                var src = new jscolor.URI(elem[i].src),
    ...
    Color: function (target, prop) {
        ...
        this.showPicker = function (target) {
            if(!isPickerOwner()) {
                var tp = jscolor.getElementPos(target), // target pos
                    ...
                    ps = [// picker size
                        2 * this.pickerBorder + 4 * this.pickerInset + 2 * this.pickerFace + jscolor.images.pad[0] +
        ...
        this.exportColor = function (flags) {
            ...
            var element = angular.element(document.getElementById("optionsControllerElement"));
            if(element.scope() && !element.scope().$$phase) {
                element.scope().colorPickerValue = value;
                document.getElementById("colorPickerField").style.backgroundColor = "#" + this.toString();
                element.scope().$apply();
            }
        ...
        function drawPicker(x, y) {
            if (!jscolor.picker) {
                ...
                jscolor.picker.box.className = "colorChooser";
                jscolor.picker.boxB.className = "colorChooser";
                jscolor.picker.pad.className = "colorChooser";
                jscolor.picker.padB.className = "colorChooser";
                jscolor.picker.padM.className = "colorChooser";
                jscolor.picker.sld.className = "colorChooser";
                jscolor.picker.sldB.className = "colorChooser";
                jscolor.picker.sldM.className = "colorChooser";
            ...
            // picker
            p.box.style.width = 4 * THIS.pickerInset + 2 * THIS.pickerFace + jscolor.images.pad[0] +
                2 * jscolor.images.arrow[0] + jscolor.images.sld[0] + "px";
        ...
        function redrawPad() {
            ...
            var seg = jscolor.picker.sld.childNodes, rgb;
            ...
            switch (modeID) {
                case 0:
                    THIS.fromHSV(x * (6 / (jscolor.images.pad[0] - 1)),
                        1 - y / (jscolor.images.pad[1] - 1), null, leaveSld);
                    break;
                case 1:
                    THIS.fromHSV(x * (6 / (jscolor.images.pad[0] - 1)),
