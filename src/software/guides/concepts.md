...
Generally used by integrators, CreateDatabase provides a way to dynamically provision customer databases.

Limits of 15 requests-per-minute, 100 requests-per-hour and 800 requests-per-day are applied.
